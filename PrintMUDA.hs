...
instance Print Stm where
  prt i e = case e of
    ...
    SAssignWithArray id exp1 exp2 -> prPrec i 0 (concatD [prt 0 id, doc (showString "["), prt 0 exp1, doc (showString "]"), doc (showString "="), prt 0 exp2, doc (showString ";")])
    ...
    SIf exp stms1 stms2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 exp, doc (showString ")"), doc (showString "{"), prt 0 stms1, doc (showString "}"), doc (showString "else"), doc (showString "{"), prt 0 stms2, doc (showString "}")])
...
instance Print Exp where
  prt i e = case e of
    EAnd exp1 exp2 -> prPrec i 0 (concatD [prt 0 exp1, doc (showString "&"), prt 1 exp2])
    EOr exp1 exp2 -> prPrec i 0 (concatD [prt 0 exp1, doc (showString "|"), prt 1 exp2])
    EXor exp1 exp2 -> prPrec i 0 (concatD [prt 0 exp1, doc (showString "^"), prt 1 exp2])
    ENot exp1 exp2 -> prPrec i 0 (concatD [prt 0 exp1, doc (showString "~"), prt 1 exp2])
    ...
    ESlElemWise exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString "<<"), prt 4 exp2])
    ESrElemWise exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString ">>"), prt 4 exp2])
    ESlaElemWise exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString "<<<"), prt 4 exp2])
    ESraElemWise exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString ">>>"), prt 4 exp2])
    ESlQWord exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString "<<|"), prt 4 exp2])
    ESrQWord exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString ">>|"), prt 4 exp2])
    ESlaQWord exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString "<<<|"), prt 4 exp2])
    ESraQWord exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString ">>>|"), prt 4 exp2])
    ...
    EDivApprox exp1 exp2 -> prPrec i 5 (concatD [prt 5 exp1, doc (showString "/."), prt 6 exp2])
